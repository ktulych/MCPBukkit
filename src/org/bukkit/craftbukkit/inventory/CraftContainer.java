...
public class CraftContainer extends net.minecraft.inventory.Container {
    ...
    @Override
    public boolean func_75129_b(net.minecraft.entity.player.EntityPlayer entityhuman) {
        ...
        if (view.getPlayer() instanceof CraftPlayer) {
            ...
            int size = getSize();
            player.getHandle().field_71135_a.func_72567_b(new net.minecraft.network.packet.Packet100OpenWindow(this.field_75152_c, type, cachedTitle, size, true));
    ...
    private void setupChest(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
        ...
        for (row = 0; row < rows; ++row) {
            for (col = 0; col < 9; ++col) {
                this.func_75146_a(new net.minecraft.inventory.Slot(top, col + row * 9, 8 + col * 18, 18 + row * 18));
            }
        }

        for (row = 0; row < 3; ++row) {
            for (col = 0; col < 9; ++col) {
                this.func_75146_a(new net.minecraft.inventory.Slot(bottom, col + row * 9 + 9, 8 + col * 18, 103 + row * 18 + i));
            }
        }

        for (col = 0; col < 9; ++col) {
            this.func_75146_a(new net.minecraft.inventory.Slot(bottom, col, 8 + col * 18, 161 + i));
        }
    ...
    private void setupWorkbench(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
        ...
        this.func_75146_a(new net.minecraft.inventory.Slot(top, 0, 124, 35));
        ...
        for (row = 0; row < 3; ++row) {
            for (col = 0; col < 3; ++col) {
                this.func_75146_a(new net.minecraft.inventory.Slot(top, 1 + col + row * 3, 30 + col * 18, 17 + row * 18));
            }
        }

        for (row = 0; row < 3; ++row) {
            for (col = 0; col < 9; ++col) {
                this.func_75146_a(new net.minecraft.inventory.Slot(bottom, col + row * 9 + 9, 8 + col * 18, 84 + row * 18));
            }
        }

        for (col = 0; col < 9; ++col) {
            this.func_75146_a(new net.minecraft.inventory.Slot(bottom, col, 8 + col * 18, 142));
        }
    ...
    private void setupFurnace(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
        ...
        this.func_75146_a(new net.minecraft.inventory.Slot(top, 0, 56, 17));
        this.func_75146_a(new net.minecraft.inventory.Slot(top, 1, 56, 53));
        this.func_75146_a(new net.minecraft.inventory.Slot(top, 2, 116, 35));
    ...
    private void setupDispenser(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
        ...
        for (row = 0; row < 3; ++row) {
            for (col = 0; col < 3; ++col) {
                this.func_75146_a(new net.minecraft.inventory.Slot(top, col + row * 3, 61 + col * 18, 17 + row * 18));
            }
        }
    ...
    private void setupEnchanting(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
        ...
        this.func_75146_a((new net.minecraft.inventory.Slot(top, 0, 25, 47)));

        int row;

        for (row = 0; row < 3; ++row) {
            for (int i1 = 0; i1 < 9; ++i1) {
                this.func_75146_a(new net.minecraft.inventory.Slot(bottom, i1 + row * 9 + 9, 8 + i1 * 18, 84 + row * 18));
            }
        }

        for (row = 0; row < 9; ++row) {
            this.func_75146_a(new net.minecraft.inventory.Slot(bottom, row, 8 + row * 18, 142));
        }
    ...
    private void setupBrewing(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
        ...
        this.func_75146_a(new net.minecraft.inventory.Slot(top, 0, 56, 46));
        this.func_75146_a(new net.minecraft.inventory.Slot(top, 1, 79, 53));
        this.func_75146_a(new net.minecraft.inventory.Slot(top, 2, 102, 46));
        this.func_75146_a(new net.minecraft.inventory.Slot(top, 3, 79, 17));

        int i;

        for (i = 0; i < 3; ++i) {
            for (int j = 0; j < 9; ++j) {
                this.func_75146_a(new net.minecraft.inventory.Slot(bottom, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
            }
        }

        for (i = 0; i < 9; ++i) {
            this.func_75146_a(new net.minecraft.inventory.Slot(bottom, i, 8 + i * 18, 142));
        }
    ...
    private void setupHopper(net.minecraft.inventory.IInventory top, net.minecraft.inventory.IInventory bottom) {
        ...
        for (i = 0; i < top.func_70302_i_(); ++i) {
            this.func_75146_a(new net.minecraft.inventory.Slot(top, i, 44 + i * 18, 20));
        }

        for (i = 0; i < 3; ++i) {
            for (int j = 0; j < 9; ++j) {
                this.func_75146_a(new net.minecraft.inventory.Slot(bottom, j + i * 9 + 9, 8 + j * 18, i * 18 + b0));
            }
        }

        for (i = 0; i < 9; ++i) {
            this.func_75146_a(new net.minecraft.inventory.Slot(bottom, i, 8 + i * 18, 58 + b0));
        }
        // End copy from ContainerHopper
    }

    public boolean func_75145_c(net.minecraft.entity.player.EntityPlayer entity) {
        return true;
    }
}
