...
public class CraftThrownPotion extends CraftProjectile implements ThrownPotion {
    ...
    public Collection<PotionEffect> getEffects() {
        return Potion.getBrewer().getEffectsFromDamage(getHandle().func_70196_i());
    }

    public ItemStack getItem() {
        // We run this method once since it will set the item stack if there is none.
        getHandle().func_70196_i();

        return CraftItemStack.asBukkitCopy(getHandle().field_70197_d);
    }
    ...
    public void setItem(ItemStack item) {
        ...
        getHandle().field_70197_d = CraftItemStack.asNMSCopy(item);
    }
