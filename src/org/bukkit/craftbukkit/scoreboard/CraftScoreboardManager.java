    ...
    public void setPlayerBoard(CraftPlayer player, org.bukkit.scoreboard.Scoreboard bukkitScoreboard) throws IllegalArgumentException {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            if (scoreboardobjective != null && !removed.contains(scoreboardobjective)) {
                entityplayer.field_71135_a.func_72567_b(new net.minecraft.network.packet.Packet206SetObjective(scoreboardobjective, 1));
        ...
        while (iterator.hasNext()) {
            ...
            entityplayer.field_71135_a.func_72567_b(new net.minecraft.network.packet.Packet209SetPlayerTeam(scoreboardteam, 1));
        }

        // The above is the reverse of the below method.
        server.func_71203_ab().func_96456_a((net.minecraft.scoreboard.ServerScoreboard) newboard, player.getHandle());
    }
